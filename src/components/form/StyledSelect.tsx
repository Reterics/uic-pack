...
export const stringsToOptions = (strings: string[], names?: string[]):  StyledSelectOption[] => {
    ...
    <div className={compact ? "w-full group flex flex-row items-center justify-between" : "relative z-0 w-full group"}>
      {label !== false && (
        <label
          htmlFor={name}
          className={
            compact ? "block mr-1 text-sm font-medium text-left text-gray-700 dark:text-gray-300" :
